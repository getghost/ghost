...
export function TrialEnded({ workspaceName, username }: Props) {
  return (
    <Layout>
      ...
      <Text>
        We hope you've enjoyed your two-week Ghost Pro trial for your workspace{" "}
      ...
      <Section>
        <Text className="font-semibold">
          It's simple to upgrade and enjoy the benefits of the Ghost Pro plan:
        </Text>
        <ul>
          <li className="pb-4">
            {" "}
      ...
      <Section className="text-center py-3">
        <Button
          href="https://app.ghost.com/settings/billing"
      ...
      <Text>
        ...
        <Link href="mailto:support@ghost.dev">support@ghost.dev</Link> or just reply to this email.
      </Text>
