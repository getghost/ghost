  ...
  return (
    <Layout>
      <Heading className="font-sans text-3xl text-semibold text-center">
        Your Ghost subscription has ended.
      </Heading>
      <Text>Hey {username},</Text>
      <Text>
        We're reaching out to let you know that your trial period has come to an end for Ghost Pro.
      ...
      <Text>
        If you want to continue with Ghost Pro, click the button below, and you can add your credit
        card.
      </Text>
