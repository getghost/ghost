...
export class Resend {
  ...
  private readonly replyTo = "support@ghost.dev";
  ...
  public async sendTrialEnded(req: {
    ...
    try {
      const result = await this.client.emails.send({
        to: req.email,
        from: "James from Ghost <james@updates.ghost.com>",
        replyTo: this.replyTo,
        subject: "Your Ghost trial has ended",
        html,
      });
  ...
  public async sendLeakedKeyEmail(req: {
    ...
    try {
      const result = await this.client.emails.send({
        ...
        from: "James from Ghost <james@updates.ghost.com>",
        replyTo: this.replyTo,
        subject: "Ghost root key exposed in public Github repository",
        html: html,
      });
      if (!result.error) {
        return;
