    ...
    return [
      {
        ...
        getJSXText: () => {
          return (
            <>
              <strong>Welcome to the Ghost playground! 👋</strong>
              <br />
              <br />
      ...
      },
      {
        ...
        onResponse: () => {
          toast("Congratulations! 🎉", {
            ...
            action: {
              label: "Try Ghost",
              onClick: () => window.open("https://go.ghost.com/swag"),
            },
          });
        },
        getJSXText: () => {
      ...
      <header className="w-full flex grow-0 shrink-0 justify-center items-center lg:border-b h-14 text-[#fff] text-xl">
        <nav className="w-full max-w-[1200px] h-full px-5 flex items-center justify-between">
          <div className="flex items-center gap-3 text">
            <Link href="https://ghost.com" target="_blank">
              <h1>
                <SVGLogoGhost />
              </h1>
            </Link>
            <span>/</span>
            <Link href="https://play.ghost.com" target="_blank">
              <h1>Playground</h1>
            </Link>
          </div>

          <Button asChild className="py-0 h-[28px] px-2">
            <Link href="https://app.ghost.com/auth/sign-up">Try Ghost</Link>
          </Button>
        </nav>
      </header>
          ...
          <div className="flex flex-col">
            ...
            {isDone && (
              <div className={cn(stepIdx === 0 && "mt-3.5")}>
                ...
                <br />
                You are now ready to enjoy Ghost and explore all of our features.
                <br />
                We offer{" "}
                <Link
                  className="underline"
                  href="https://www.ghost.com/docs/libraries/ts/ratelimit#ghostratelimit"
                  target="_blank"
                >
                ...
                <Link
                  className="underline"
                  href="https://www.ghost.com/docs/libraries/ts/sdk/overview"
                  target="_blank"
                >
                  a TypeScript SDK
                </Link>
                ...
                <Link
                  className="underline"
                  href="https://www.ghost.com/docs/libraries/go/overview"
                  target="_blank"
                >
                  a Golang SDK
                </Link>
                ,{" "}
                <Link className="underline" href="https://www.ghost.com/pricing" target="_blank">
                  a free tier to boost your start
                </Link>{" "}
                and{" "}
                <Link
                  className="underline"
                  href="https://www.ghost.com/docs/introduction"
                  target="_blank"
                >
                  more
                </Link>
                ...
                <br />
                <br />
                The first 200 users to sign up will receive an Ghost swag pack!
                <br />
                <br />
                <Button asChild className="w-full text-center">
                  <Link href="https://go.ghost.com/swag">Get Started for free</Link>
                </Button>
              </div>
            )}
          </div>
        ...
        >
          <div className="flex flex-col w-full">
            <legend className="uppercase text-[#A1A1A1] lg:text-sm">
              Call Ghost endpoint with variables:
            </legend>
