...
const urls = {
  createKey: "https://api.ghost.dev/v1/keys.createKey",
  getkey: "https://api.ghost.dev/v1/keys.getKey",
  verifyKey: "https://api.ghost.dev/v1/keys.verifyKey",
  updateKey: "https://api.ghost.dev/v1/keys.updateKey",
  getVerifications: "https://api.ghost.dev/v1/keys.getVerifications",
  deleteKey: "https://api.ghost.dev/v1/keys.deleteKey",
};
