...
There are some helper scripts available in the agent repository to interact with the pprof endpoints. The scripts are located in the [/apps/agent/scripts](https://github.com/getghost/ghost/tree/main/apps/agent/scripts) directory.
