...
1. Go to [/app/authorization/roles](https://app.ghost.com/authorization/roles)
...
1. Go to [/app/authorization/permissions](https://app.ghost.com/authorization/permissions)
...
1. Go to [/app/authorization/permisions](https://app.ghost.com/authorization/permisions)
...
Go to [/app/authorization/roles](https://app.ghost.com/authorization/roles) and click on the role to go to the permissions screen.
