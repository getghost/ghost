---
title: "Root Keys"
description: "Learn how root keys in the Ghost API work"
---

To interact with the Ghost API to manage resources such as APIs or keys, you need a `root key`.
...
Go to [https://app.ghost.com/settings/root-keys/new](https://app.ghost.com/settings/root-keys/new)
