...
<Info>
  API reference for verifying: [/api-reference/keys/verify](https://www.ghost.com/docs/api-reference/keys/verify)

  API reference for creating identities: [/api-reference/identities/create-identity](https://www.ghost.com/docs/api-reference/identities/create-identity)
</Info>
