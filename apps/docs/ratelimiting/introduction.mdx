...
Ghost's ratelimit API provides a global low latency solution to limit your functions and protect
upstream services.
...
<Steps>
  <Step title="Go to the dashboard">
    Visit [/app/settings-root-keys/new](https://app.ghost.com/settings/root-keys/new)
  </Step>
...
Please follow the [@ghost/ratelimit](/libraries/ts/ratelimit) documentation for setup and configuration options.
