...
To access the Audit Logs, click [here](https://app.ghost.com/audit) or on the **Audit Logs** option in the left navigation bar.
...
Need additional functionality from audit logs, beyond what is provided currently? [Get in touch](mailto:support@ghost.dev)!
