---
title: "Overview"
description: "Typescript client for ghost"
---

If you prefer a typed experience over calling http endpoints directly, you can use our sdk `@ghost/api`.
...
When creating, revoking or updating resources, you will need your root key — you can create a new one in the [settings](https://app.ghost.com/settings/root-keys).
...
Run all requests against your own instance of ghost hosted on your own infrastructure.

<ParamField body="baseUrl" type="string" default="https://api.ghost.dev">
...
By default, Ghost collects anonymous telemetry data to help us understand which versions of our SDK is being used, and in which environment.
