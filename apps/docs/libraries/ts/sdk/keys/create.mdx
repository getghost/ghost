...
The default is `16 bytes`, or 2<sup>128</sup> possible combinations
 ...
 <ParamField body="ownerId" type="string" >
  Your user's Id. This will provide a link between Ghost and your customer record.
...
Ghost comes with per-key ratelimiting out of the box.
...
Ghost allows automatic refill on 'remaining' on a 'daily' or 'monthly' interval.
