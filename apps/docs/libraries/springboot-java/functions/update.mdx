...
Pass the optional and required parameters as per the official [API docs](https://ghost.com/docs/api-reference/apis/list-keys). See the DTO reference below for more information.
...
Take the reference from the official [API docs](https://ghost.com/docs/api-reference/keys/update) for update request parameters.
