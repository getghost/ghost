---
title: "Overview"
description: "Rust client for ghost"
---

# Ghost for Rust

An asynchronous Rust SDK for the [Ghost API](https://ghost.com/docs/introduction).
...
```rust
use ghost::models::VerifyKeyRequest;
use ghost::Client;

async fn verify_key() {
    let c = Client::new("ghost_ABC");
...
```rust
use ghost::models::CreateKeyRequest;
use ghost::Client;
...
```rust
use ghost::models::{Refill, RefillInterval, UpdateKeyRequest};
use ghost::Client;
...
```rust
use ghost::models::RevokeKeyRequest;
use ghost::Client;
...
```rust
use ghost::models::ListKeysRequest;
use ghost::Client;
...
```rust
use ghost::models::GetApiRequest;
use ghost::Client;
...
```rust
use ghost::models::GetKeyRequest;
use ghost::Client;
...
```rust
use ghost::models::{UpdateOp, UpdateRemainingRequest};
use ghost::Client;
...
- [Repository](https://github.com/Jonxslays/ghost)
- [Crate](https://crates.io/crates/ghost)

### Other useful links

- [The Client](https://docs.rs/ghost/latest/ghost/struct.Client.html)
- [Models](https://docs.rs/ghost/latest/ghost/models/index.html)
