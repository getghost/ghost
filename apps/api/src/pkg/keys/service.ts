...
import { BaseError, Err, FetchError, Ok, type Result, SchemaError, wrap } from "@ghost/error";
import { sha256 } from "@ghost/hash";
import type { PermissionQuery, RBAC } from "@ghost/rbac";
import type { Logger } from "@ghost/worker-logging";
...
export class KeyService {
  ...
  private async ratelimit(
    ...
    if (res.val.triggered !== null) {
       ...
       */
      c.res.headers.set("Ghost-Ratelimit-Triggered", res.val.triggered);
    }
