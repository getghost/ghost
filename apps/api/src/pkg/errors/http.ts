  ...
  return z.object({
    error: z.object({
      ...
      docs: z.string().openapi({
        ...
        example: `https://ghost.dev/docs/api-reference/errors/code/${code._def.values.at(0)}`,
      }),
      message: z
        .string()
...
export const ErrorSchema = z.object({
  error: z.object({
    ...
    docs: z.string().openapi({
      description: "A link to our documentation with more details about this error code",
      example: "https://ghost.dev/docs/api-reference/errors/code/BAD_REQUEST",
    }),
...
export class GhostApiError extends HTTPException {
    ...
    return c.json<z.infer<typeof ErrorSchema>>(
      {
        error: {
          code: err.code,
          docs: `https://ghost.dev/docs/api-reference/errors/code/${err.code}`,
          message: err.message,
          requestId: c.get("requestId"),
        },
      },
    ...
    return c.json<z.infer<typeof ErrorSchema>>(
      {
        error: {
          code,
          docs: `https://ghost.dev/docs/api-reference/errors/code/${code}`,
          message: err.message,
          requestId: c.get("requestId"),
        },
      },
  ...
  return c.json<z.infer<typeof ErrorSchema>>(
    {
      error: {
        ...
        docs: "https://ghost.dev/docs/api-reference/errors/code/INTERNAL_SERVER_ERROR",
