import { type Cache as C, Namespace, createCache } from "@ghost/cache";
import { withMetrics } from "@ghost/cache/middleware";
import { CloudflareStore, MemoryStore, type Store } from "@ghost/cache/stores";
