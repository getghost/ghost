        ...
        "application/json": {
          schema: z.object({
            migrationId: z.string().openapi({
              description: "Contact support@ghost.dev to receive your migration id.",
            }),
...
When validating a key, we will return this back to you, so you can clearly identify your user from their api key.`,
                  ...
                  ratelimit: z
                    ...
                    .openapi({
                      description:
                        "Ghost comes with per-key fixed-window ratelimiting out of the box.",
                      example: {
                        type: "fast",
                        limit: 10,
                        duration: 60_000,
