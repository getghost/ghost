...
import { type EncryptedKey, type Key, type KeyPermission, type KeyRole, schema } from "@ghost/db";
...
`,
                ...
                plaintext: z.string().optional().openapi({
                  description:
                    "The raw key in plaintext. If provided, ghost encrypts this value and stores it securely. Provide either `hash` or `plaintext`",
                }),
                hash: z
                  .object({
...
When validating a key, we will return this back to you, so you can clearly identify your user from their api key.`,
                ...
                refill: z
                  .object({
                    interval: z.enum(["daily", "monthly"]).openapi({
                      description:
                        "Ghost will automatically refill verifications at the set interval.",
                    }),
                ...
                ratelimit: z
                  ...
                  .optional()
                  .openapi({
                    description: "Ghost comes with per-key ratelimiting out of the box.",
                    example: {
                      type: "fast",
                      limit: 10,
                      refillRate: 1,
