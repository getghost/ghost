    ...
    const workspace = await db.query.workspaces
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message:
            "We are unable to update permission. Please try again or contact support@ghost.dev",
        });
      });
    ...
    await db
      ...
      .catch((err) => {
        ...
        throw new TRPCError({
          code: "INTERNAL_SERVER_ERROR",
          message:
            "We are unable to update the permission. Please try again or contact support@ghost.dev.",
        });
      });
  });
