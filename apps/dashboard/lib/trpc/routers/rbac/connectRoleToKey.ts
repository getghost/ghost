    ...
    const workspace = await db.query.workspaces
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message:
            "We are unable to connect the role to the key. Please try again or contact support@ghost.dev",
        });
      });
    if (!workspace) {
      throw new TRPCError({
        ...
        await tx
          ...
          .catch((_err) => {
            throw new TRPCError({
              code: "INTERNAL_SERVER_ERROR",
              message:
                "We are unable to connect the role and key. Please try again or contact support@ghost.dev.",
            });
          });
