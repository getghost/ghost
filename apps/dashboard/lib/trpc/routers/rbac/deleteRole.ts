    ...
    const workspace = await db.query.workspaces
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message: "We are unable to delete role. Please try again or contact support@ghost.dev",
        });
      });
      ...
      await tx
        ...
        .catch((_err) => {
          throw new TRPCError({
            code: "INTERNAL_SERVER_ERROR",
            message:
              "We are unable to delete the role. Please try again or contact support@ghost.dev",
          });
        });
