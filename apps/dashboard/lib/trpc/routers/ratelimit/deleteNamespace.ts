    ...
    const namespace = await db.query.ratelimitNamespaces
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message:
            "We are unable to delete namespace. Please try again or contact support@ghost.dev",
        });
      });
        ...
        await tx
          ...
          .catch((_err) => {
            throw new TRPCError({
              code: "INTERNAL_SERVER_ERROR",
              message:
                "We are unable to delete the namespaces. Please try again or contact support@ghost.dev",
            });
          });
