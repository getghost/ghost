    ...
    const keyAuth = await db.query.keyAuth
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message: "We were unable to find KeyAuth. Please try again or contact support@ghost.dev.",
        });
      });
    ...
    await db
        ...
        await tx
          ...
          .catch((_err) => {
            throw new TRPCError({
              code: "INTERNAL_SERVER_ERROR",
              message:
                "We were unable to update the API default prefix. Please try again or contact support@ghost.dev.",
            });
          });
      ...
      .catch((_err) => {
        throw new TRPCError({
          code: "INTERNAL_SERVER_ERROR",
          message:
            "We were unable to update the default prefix. Please try again or contact support@ghost.dev.",
        });
      });
  });
