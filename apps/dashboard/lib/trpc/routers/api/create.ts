  ...
  .mutation(async ({ input, ctx }) => {
    const ws = await db.query.workspaces
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message: "We are unable to create an API. Please try again or contact support@ghost.dev",
        });
      });
    if (!ws) {
      throw new TRPCError({
    ...
    await db
        ...
        await tx
          ...
          .catch((_err) => {
            throw new TRPCError({
              code: "INTERNAL_SERVER_ERROR",
              message:
                "We are unable to create the API. Please try again or contact support@ghost.dev",
            });
          });
      ...
      .catch((_err) => {
        throw new TRPCError({
          code: "INTERNAL_SERVER_ERROR",
          message: "We are unable to create the API. Please try again or contact support@ghost.dev",
        });
      });
