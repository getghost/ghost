    ...
    const key = await db.query.keys
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message:
            "We were unable to update ratelimits on this key. Please try again or contact support@ghost.dev",
        });
      });
      ...
      await db
        ...
        .catch((err) => {
          ...
          throw new TRPCError({
            code: "INTERNAL_SERVER_ERROR",
            message:
              "We were unable to update ratelimit on this key. Please try again or contact support@ghost.dev",
          });
        });
    }
  });
