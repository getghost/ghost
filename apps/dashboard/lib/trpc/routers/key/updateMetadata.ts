    ...
    const key = await db.query.keys
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message:
            "We were unable to update metadata on this key. Please try again or contact support@ghost.dev",
        });
      });
        ...
        await tx
          ...
          .catch((_err) => {
            throw new TRPCError({
              code: "INTERNAL_SERVER_ERROR",
              message:
                "We are unable to update metadata on this key. Please try again or contact support@ghost.dev",
            });
          });
