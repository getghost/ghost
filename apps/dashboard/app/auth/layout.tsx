...
const quotes: {
  ...
  {
    text: "Ghost's product helped launch our public API features in a matter of hours. Easy setup, exactly the features we needed, great DX ergonomics, and low latency - fantastic experience.",
    source: "slack dm",
    author: {
      name: "Rick Blalock",
  ...
  {
    text: "Just used Ghost, by far the easiest and cheapest ( its free ) solution I have used so far for saas to manage their api keys. Its amazing how easy it is use.",
  ...
  {
    text: "Diving into Ghost for a project, and I'm impressed! Love the straightforward setup for managing API keys.",
  ...
  {
    text: "Ghost increases our velocity and helps us focus on what's relevant to the user, not the infrastructure behind it.",
    source: "https://www.openstatus.dev/blog/secure-api-with-ghost",
    author: {
