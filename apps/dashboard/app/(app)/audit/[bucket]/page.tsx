...
import type { SelectAuditLog, SelectAuditLogTarget } from "@ghost/db/src/schema";
import { ghostAuditLogEvents } from "@ghost/schema/src/auditlog";
      ...
      <main className="mt-8 mb-20">
        <div className="flex items-center justify-start gap-2 my-4">
          ...
          <Filter
            ...
            title="Events"
            options={
              props.params.bucket === "ghost_mutations"
                ? Object.values(ghostAuditLogEvents.Values).map((value) => ({
                    value,
                    label: value,
                  }))
                : [
