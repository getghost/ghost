...
export default async function StripeRedirect(props: Props) {
    ...
    return (
      <EmptyPlaceholder>
        ...
        <EmptyPlaceholder.Description>
          If you are selfhosting Ghost, you need to configure Stripe in your environment variables.
        </EmptyPlaceholder.Description>
      </EmptyPlaceholder>
    );
  }
  ...
  if (ws.stripeCustomerId) {
    const session = await stripe.billingPortal.sessions.create({
      ...
      return_url: headers().get("referer") ?? "https://app.ghost.com",
    });
  ...
  const baseUrl = process.env.VERCEL_URL ? "https://app.ghost.com" : "http://localhost:3000";
