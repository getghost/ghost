        ...
        <div>
          <div className="flex flex-row text-center">
            <div className="mx-auto flex-flex-col ">
              <a href="https://x.com/ghostdev" target="_blank" rel="noreferrer">
              ...
              <p className="mt-6 font-normal leading-7 text-balance">
                ...
                Here you can find the latest updates and changes to Ghost.
              </p>
            </div>
          </div>
...
export const metadata = {
  title: "Changelog | Ghost",
  description: "Stay up-to-date with the latest updates and changes to Ghost",
  openGraph: {
    title: "Changelog | Ghost",
    description: "Stay up-to-date with the latest updates and changes to Ghost",
    url: "https://ghost.com/changelog",
    siteName: "ghost.com",
    images: [
      {
        url: "https://ghost.com/og/changelog",
        width: 1200,
        height: 675,
      },
    ],
