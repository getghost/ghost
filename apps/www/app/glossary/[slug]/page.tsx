...
export function generateMetadata({
  ...
  return {
    title: `${term.title} | Ghost Glossary`,
    description: term.description,
    openGraph: {
      title: `${term.title} | Ghost Glossary`,
      description: term.description,
      url: `https://ghost.com/glossary/${term.slug}`,
      siteName: "ghost.com",
      type: "article",
    },
    twitter: {
              ...
              <div className="mt-12 sm:mx-6">
                <FAQ
                  items={[
                    ...
                    {
                      question: "Which mime types are supported by Ghost?",
                      answer:
                        "Ghost supports a wide range of mime types, including text, image, audio, video, and application-specific types. The full list of supported mime types can be found in the Ghost documentation.",
                    },
                  ]}
