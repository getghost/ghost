...
import {
  AccelerateGhostCacheIcon,
  AccelerateGhostCacheIllustration,
} from "./components/ghost-cache";

const pageConfig = {
  name: "Ghost Accelerate | 24-29 June 2024",
  description:
    "A week of new features that redefine API Management, allowing you to create performant and scalable APIs with ease.",
  ogImage: "https://ghost.com/assets/accelerate/og.png",
};
...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://ghost.com"),
  description: pageConfig.description,
  keywords: ["ghost", "api", "service", "accelerate"],
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://ghost.com/accelerate",
...
const DAYS: AccelerateLaunchDay[] = [
  ...
  },
  {
    ...
    dayAndMonth: "25 Jun",
    weekday: "Tue",
    title: "npm i @ghost/cache",
    description: "Serverless caching that doesn't suck",
    blog: "/blog/announcing-ghost-cache-package",
    IconComponent: AccelerateGhostCacheIcon,
    IllustrationComponent: AccelerateGhostCacheIllustration,
  },
  {
    dateTime: "2024-06-26",
    dayAndMonth: "26 Jun",
    ...
    <div className="flex flex-col">
      <div className="isolate container flex flex-col items-center mt-[64.5px] font-mono uppercase text-white/30 text-base">
        ...
        <div className="mt-24 lg:mt-[10.5rem] py-4 lg:py-6 text-white w-full flex justify-between items-center border-b-[1px] border-white/10 opacity-0 animate-fade-in [animation-delay:4s]">
          <h3 className="max-w-[30%]">Ghost Accelerate 2024</h3>
          <Link
            className="flex items-center gap-3 transition hover:opacity-50"
            href="https://x.com/ghostdev"
            target="_blank"
          >
        ...
        <div className="mt-12 lg:mt-24 w-full flex flex-col lg:flex-row gap-10 lg:gap-0 items-center lg:justify-between text-sm leading-6 text-center opacity-0 animate-fade-in [animation-delay:5s]">
          ...
          <div className="flex flex-col lg:text-right">
            <span className="text-white">GHOST LABs</span>
