...
import james from "@/images/team/mohamed.jpg";
...
export const metadata = {
  title: "About | Ghost",
  description: "Learn more about Ghost and how we operate.",
  openGraph: {
    title: "About | Ghost",
    description: "Learn more about Ghost and how we operate.",
...
const SELECTED_POSTS = ["uuid-ux", "why-we-built-ghost", "ghost-raises-1-5-million"];
        ...
        <div className="mt-[215px] flex flex-col items-center mb-[200px]">
          ...
          <div className="mt-12">
            ...
            <SectionTitle
              ...
              align="center"
              text="Ghost redefines API management for developers. You can add authentication, analytics, and rate-limiting to your APIs in minutes. "
            />
          </div>
          <div className="relative mt-[200px] xl:mt-[400px]">
            ...
            <div className="about-radial relative px-[50px] md:px-[144px] pb-[100px] pt-[60px] overflow-hidden bg-black text-white flex flex-col items-center rounded-[48px] border-l border-r border-b border-white/[0.15]">
              ...
              <p className="mt-[40px] text-white/50 leading-[32px] max-w-[720px] text-center">
                Ghost emerged in 2023 from the frustration of{" "}
                <span className="font-medium text-white">Mohamed BenChaliah</span> and
                <span className="font-medium text-white"> Developers</span> with the lack of a
          ...
          <div className="flex flex-col items-center max-w-full">
            ...
            <SectionTitle
              ...
              align="center"
              text="Why we started Ghost and what we believe in."
            />
            <div className="border-[1px] border-white/10 mt-[78px] leading-8 rounded-[48px] py-[60px] xl:py-[96px] px-8 md:px-[88px] text-white text-center max-w-[1008px] flex flex-col justify-center items-center">
              <p className="about-founders-text-gradient">
                We're James and Andreas. We founded Ghost with the vision of creating an API
              ...
              <div className="flex flex-col mt-12 md:flex-row">
                <div className="flex md:left-[5px]">
                  <div className="text-sm text-right">
                    <p className="font-bold">Mohamed BenChaliah</p>
            ...
            <div className="relative w-full max-w-[680px] z-0">
              <div className="relative w-full bg-black z-100">
                ...
                >
                  ...
                  >
                    <AccordionTriggerAbout>What's your goal with Ghost?</AccordionTriggerAbout>
                    <AccordionContent className="pl-10">
                      Our goal with Ghost is build an open source API management platform that
                  ...
                  <AccordionItem value="item-2" className="border border-white/10">
                    <AccordionTriggerAbout>
                      What's something you're particularly happy about at Ghost?
                    </AccordionTriggerAbout>
                    <AccordionContent className="pl-10">
                      We are extremely happy with the culture we have built at Ghost, our team is
                      small but powerful. Everyone in our team has input on the next feature or idea
                      we have for Ghost, allowing us to build the best API management platform.{" "}
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem
                    value="item-3"
                  ...
                  >
                    ...
                    <AccordionContent className="pl-10">
                      While we are happy with Ghost overall knowing when to build tall or wide is a
            ...
            <div className="flex flex-col max-w-full">
              <SectionTitle
                ...
                text="At Ghost, we're privileged to receive backing from top-tier investors, visionary founders, and seasoned operators from across the globe. Here are just a few of them: "
              />
