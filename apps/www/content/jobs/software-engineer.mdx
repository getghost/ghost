...
Ghost currently uses the following tech:
...
Send your resume to [jobs@ghost.dev](mailto:jobs@ghost.dev) with the reason you’d love to work at Ghost and any additional details.
