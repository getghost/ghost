...
```bash
docker run -p 8000:8000 -e TINYBIRD_TOKEN="abc" ghcr.io/getghost/tinybird-proxy:latest
```


### Config

See the [readme](https://github.com/getghost/ghost/tree/main/apps/agent#config) for all available options.
