...
Before starting Ghost, I worked at several companies ranging in size from 5 to 5,000 employees, and one of the biggest hurdles a company can face is how to encourage authentic communication.
...
## How are we attempting this at Ghost?

Ghost lives on being open from the top; Andreas and I ensure everyone understands how Ghost runs, what we expect, and the company's direction. So, for our team to feel empowered to be their authentic self when communicating, we do the following:
...
I understand that our current implementation won’t scale past 20 or 30 team members; we will tweak this to allow for authenticated communication as we keep this a core value at Ghost.
