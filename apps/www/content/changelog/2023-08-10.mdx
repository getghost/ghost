...
date: 2023-08-11
description: We spent some time fixing bugs and improving performance of Ghost.
tags: ["product"]
---
...
- We also now have a theme switcher which allows you to enjoy Ghost in dark mode.
...
We made Ghost easier to self host, we have hidden Kafka and Tinybird behind generic interfaces to provide more flexibility, you can now pass in flags to enable specific providers:
...
[How Ghost can help AI developers](https://ghost.com/blog/how-we-ai)

[OCR as a service with Ghost](https://ghost.com/blog/ocr-service)
