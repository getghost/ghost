...
Ghost has always focused on making securing your APIs more accessible than ever. With the introduction of our Authorization offering, we wanted to simplify how you can see what roles and permissions are assigned to a key and update them as needed.
...
### How to build and authenticate an AI API using Modal, Neon, and Ghost

If you want to learn how to use Neon Postgres and Modal to build, host, and deploy an OpenAI Whisper API - fully secured by Ghost. We collaborated with the team at Neon team to create a tutorial that walks you through the process. You can find the tutorial [here](https://neon.tech/blog/how-to-build-and-authenticate-an-ai-api-using-modal-neon-and-ghost).

### Decoding CLI Auth

Command Line Interfaces (CLI) have become integral tools for developers looking to streamline their workflows, but how does CLI authentication work? In our latest blog post, we break down the process of authenticating a CLI tool and how Ghost can help. You can find the blog post [here](https://ghost.com/blog/cli-auth).
