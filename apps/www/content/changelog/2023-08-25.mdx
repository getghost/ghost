...
When you sign up for an Ghost account you now get a new onboarding experience. We take you through creating a workspace, API and showing how Ghost works before you land in the dashboard.
...
![Step 1](/images/changelog/aug-25/ghost-onboard-step-1.png)
...
![Step 2](/images/changelog/aug-25/ghost-onboard-step-2.png)

Finally we show you how to use Ghost, we show you how to create a root key, how to use it in your application and how to create a regular key.

![Step 3](/images/changelog/aug-25/ghost-onboard-step-4.png)

We think this experience will help new users get up to speed with Ghost and make it easier to get started. Let us know what you think!
...
Have you ever worked with a third party lib, and you received an “Oops try again” error or an extremely vague error that gives you zero indication of what caused it? Great news! Ghost’s error response provide everything you could need to rectify the problem. Every error response will return:

An error code, a link to the documentation, an informative message, and a requestId that you can provide to Ghost support to track down.

![Example of an error code](/images/changelog/aug-25/error-example.png)

## SDK improvements

Our typescript package `@ghost/api` got two upgrades this week, to make it even faster to integrate Ghost into your project.
...
Huge shoutout to [atridadl](https://github.com/atridadl) for creating a starter project using T3, Clerk, Ghost and Drizzle. Check out the link below!
