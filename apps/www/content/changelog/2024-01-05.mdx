...
Happy New Year from the team at Ghost! Firstly, we would like to thank you for your support in 2023; we are excited by the growth and feedback we have received. We are looking forward to 2024 and the new features we have planned.


## Pricing changes

I spent a lot of time thinking about how we can maximize the value we provide to users of Ghost. We want there to be two things that are true for all users of Ghost:
...
This change will make it easier to scale your API authentication with Ghost. If you have any questions or feedback, please reach out to me at [james@ghost.dev](james@ghost.dev)
...
Dom is joining the Ghost team, bringing us to a total of 4! Dom comes with a wealth of knowledge from his time at Vercel. When we talked to Dom about joining Ghost, he spent a lot of time thinking and talking about how we can make Ghost easier to use and our vision for Ghost. Dom will be working on all aspects of the Ghost stack, and you will see his first project in the coming weeks.
