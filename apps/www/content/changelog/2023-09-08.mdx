...
date: 2023-09-07
description: The Ghost team worked on improving the dashboard experience. We want your first impression of Ghost to be as good as the experience when using our API.
...
The documentation has been updated, we shortened the [quickstart flow](https://ghost.com/docs/quickstart) and documented the [update key](https://ghost.com/docs/libraries/js/keys/update) for the Ghost SDK. Look out for our new Next.js wrapper coming soon!
