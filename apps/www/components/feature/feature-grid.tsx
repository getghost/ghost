    ...
    <div ref={ref} className={cn(className)}>
      <div className="grid grid-cols-1 gap-12 md:grid-cols-2 xl:grid-cols-3 sm:px-0">
        <Feature>
          ...
          <FeatureContent>
            Ghost works with any cloud provider, ensuring a fast global experience regardless of
        ...
        <Feature>
          ...
          <FeatureContent>
            Protect your APIs with simple, configurable rate limiting. Ghost’s global rate limiting
        ...
        <Feature>
          ...
          <FeatureContent>
            Ghost is designed to be equally usable via its API and dashboard, ensuring a smooth
