import { z } from "zod";
import type { ghostPermissionValidation } from "./permissions";
...
/**
 * buildGhostQuery is preloaded with out available roles and ensures typesafety for root key validation
 */
export const buildGhostQuery = buildQuery<z.infer<typeof ghostPermissionValidation>>;
